module github.com/cisco-open/kubei/backend
...
require (
	...
	github.com/google/go-containerregistry/pkg/authn/kubernetes v0.0.0-20220310143843-f1fa40b162a1 // indirect
...
replace (
	...
	github.com/cisco-open/kubei/runtime_scan v0.0.0 => ./../runtime_scan
